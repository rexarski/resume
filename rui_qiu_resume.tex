...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItemAlt
        {Develop metrics (such as fairness, explainability, and adversarial robustness score) to evaluate the performance of MALENA (Machine Learning ESG Analyst)}
        \resumeItemAlt
        {Train and fine-tune transformer-based NLP and NLU models (including RoBERTa and DistilBERT) to enhance the robustness and stability of MALENA}
        \resumeItemAlt
        {Collaborate with CEG and IFC stakeholders to understand their requirements and designed innovative dashboards for machine learning inference data visualization}
        \resumeItemAlt
        {Improve efficiency by cleaning up and scheduling batch jobs in the Databricks cluster, which provided periodic summary statistics for the dashboard}
    \resumeItemListEnd
