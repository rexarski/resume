...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItemAlt{Leverage GPT-3.5 and LangChain to enable question answering in context for IFC's ESG reports, saving almost 90\% of the time for analysts to extract information from the reports}
        \resumeItemAlt{Develop and fine-tune transformer-based language models (ClimateBERT) for climate-related downstream tasks, improve the accuracy of factchecking by 6\% (WIP)}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemAlt
          {Improved user experience (UX) metrics by 20\% through increased user feedback collection and frequent iteration based on customer needs}
        \resumeItemAlt
