...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Big Data \& Miscellaneous Technologies}{: AWS, Azure, databricks, Spark, Hadoop, MongoDB, Docker, Linux, Shell, Hugo, Figma}
      % \hfill
      % \textbf{}{: }
    }\vspace{-8pt}
  \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListEnd
  	...
  	\resumeItemListStart
  		\resumeItemAlt
          {Worked as a graduate teaching assistant for ANLY-503 (Advanced Data Visualization) and ANLY-560 (Time Series)}
         \resumeItemAlt{Delivered weekly office hours and assignment grading for a group of 30+ students}
         \resumeItemAlt{Assisted in sharing course-related materials, managing course Slack channel and GitHub organization}
  	\resumeItemListEnd
