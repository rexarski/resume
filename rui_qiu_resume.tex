...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Data Scientist Intern}{Aug. 2016 -- Present}
    \resumeItemListStart
        \resumeItemAlt
        {Craft the right test harness to ensure machine learning models are tested using appropriate model evaluation techniques (bias detection)}
        \resumeItemAlt
        {Refine/Retrain MALENA (Machine Learning ESG Analyst) Natural Language Processing \& Natural Language Understanding models}
        \resumeItemAlt
        {Conduct exploratory data discovery, cleaning, and analysis to address use cases}
    \resumeItemListEnd
